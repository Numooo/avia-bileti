...
const initialNotifications: Notification[] = [
    {id: 1, text: "╨Т╨░╤И ╤А╨╡╨╣╤Б ╨▓ ╨б╤В╨░╨╝╨▒╤Г╨╗ ╨┐╨╛╨┤╤В╨▓╨╡╤А╨╢╨┤╨╡╨╜", unread: true, time: "2╤З ╨╜╨░╨╖╨░╨┤"},
    {id: 2, text: "╨Э╨╛╨▓╨╛╨╡ ╤Б╨┐╨╡╤Ж╨┐╤А╨╡╨┤╨╗╨╛╨╢╨╡╨╜╨╕╨╡: -20% ╨╜╨░ ╨╛╤В╨╡╨╗╨╕ ╨▓ ╨Ф╤Г╨▒╨░╨╡", unread: true, time: "5╤З ╨╜╨░╨╖╨░╨┤"},
    {id: 3, text: "╨Ф╨╛╨▒╤А╨╛ ╨┐╨╛╨╢╨░╨╗╨╛╨▓╨░╤В╤М ╨▓ Uvidha Escapes!", unread: false, time: "1╨┤ ╨╜╨░╨╖╨░╨┤"},
];
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        <div className="relative">
                                            ...
                                            {/* 3. ╨Я╤А╨╛╨▓╨╡╤А╤П╨╡╨╝ ╨╜╨░╨╗╨╕╤З╨╕╨╡ ╨╜╨╡╨┐╤А╨╛╤З╨╕╤В╨░╨╜╨╜╤Л╤Е ╨┐╨╛ ╤Б╤В╨╡╨╣╤В╤Г notifications */}
                                        ...
                                        {userDropdownOpen && (
                                            ...
                                            >
                                                ...
                                                <div className="max-h-48 overflow-y-auto">
                                                    {/* 4. ╨Ь╨░╨┐╨╕╨╝ ╤Б╤В╨╡╨╣╤В notifications, ╨░ ╨╜╨╡ ╨╜╨░╤З╨░╨╗╤М╨╜╤Л╨╣ ╨╝╨░╤Б╤Б╨╕╨▓ */}
                                                    {notifications.map((n) => (
                                                        <div
                                                            key={n.id}
                                                            // 5. ╨Т╤Л╨╖╤Л╨▓╨░╨╡╨╝ ╤Д╤Г╨╜╨║╤Ж╨╕╤О ╨┐╤А╨╕ ╨║╨╗╨╕╨║╨╡
