...
export function HolidaySearch({ onSearch }: HolidaySearchProps) {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      {/* Search Button */}
      <div className="lg:col-span-4 flex flex-col md:flex-row gap-4 items-end">
        ...
        <button
          ...
          className="w-full md:w-auto md:min-w-[200px] rounded-xl bg-brand-primary py-4 px-8 text-white font-bold shadow-lg shadow-brand-primary/20 hover:bg-brand-secondary transition-all flex items-center justify-center gap-3"
        >
